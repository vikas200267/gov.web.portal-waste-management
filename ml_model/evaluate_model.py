...
Evaluates the performance of the waste prediction ML models
"""
import pandas as pd
import numpy as np
...
def plot_predictions(pollution_results, gw_results, output_path='model_evaluation.png'):
