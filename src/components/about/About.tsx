...
export const About: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Sensor Data Collection</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">ML Model Processing</h3>
            <p className="text-gray-600">
      ...
      {/* Benefits Section */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Environmental Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h4 className="font-semibold text-gray-900 mb-2">Sensor Technology</h4>
